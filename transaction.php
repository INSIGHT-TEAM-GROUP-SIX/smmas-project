        ...
        if($available < $quantity) {
            ...
            try {
                ...
                <div class="success">
                    ...
                    <strong>ID:</strong> ' . $transaction_id . '<br>
                    <strong>Medicine:</strong> ' . $medicine_name . '<br>
                    <strong>Quantity:</strong> ' . $quantity . '<br>
                    <strong>Total:</strong> UGX ' . number_format($quantity * $unit_price) . '<br><br>
...
<td>
<?php echo $r['medicine_name']; ?>
</td>

<td>
<?php echo $r['transaction_type']; ?>
</td>
