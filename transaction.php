    ...
    if($transaction_type == 'Dispense') {
        ...
        if($available < $quantity) {
            ...
            try {
                ...
                $updateBatch->execute([$quantity, $batch_id]);

                /* Reduce medicine stock */
                $updateMedicine = $conn->prepare("
                    UPDATE Medicine
                    SET current_stock = current_stock - ?
                    WHERE medicine_id = ?
                ");

                $updateMedicine->execute([$quantity, $medicine_id]);
                ...
                <div class="success">
                    ...
                    Total Amount: UGX ' . number_format($total) . '<br><br>
...
<br><small>FEFO = First Expiry, First Out</small>
...
<td>
<?php echo date('d M Y H:i', strtotime($r['transaction_date'])); ?>
</td>
